...
function gigpress_add() {
	...
	<?php } ?>
		...
		<table class="optiontable editform gp-table">
		  <tr>
			<th scope="row"><label for="mm"><strong><?php _e("Date", "gigpress") ?>:</strong></label></th>
			<?php 
			...
			<td><select name="mm" id="mm">
				  <option value="01"<?php if(date('m') == "01") echo(' selected="selected"'); ?>><?php _e("January"); ?></option>
			  	  <option value="02"<?php if(date('m') == "02") echo(' selected="selected"'); ?>><?php _e("February"); ?></option>
				  <option value="03"<?php if(date('m') == "03") echo(' selected="selected"'); ?>><?php _e("March"); ?></option>
				  <option value="04"<?php if(date('m') == "04") echo(' selected="selected"'); ?>><?php _e("April"); ?></option>
				  <option value="05"<?php if(date('m') == "05") echo(' selected="selected"'); ?>><?php _e("May"); ?></option>
				  <option value="06"<?php if(date('m') == "06") echo(' selected="selected"'); ?>><?php _e("June"); ?></option>
				  <option value="07"<?php if(date('m') == "07") echo(' selected="selected"'); ?>><?php _e("July"); ?></option>
				  <option value="08"<?php if(date('m') == "08") echo(' selected="selected"'); ?>><?php _e("August"); ?></option>
				  <option value="09"<?php if(date('m') == "09") echo(' selected="selected"'); ?>><?php _e("September"); ?></option>
				  <option value="10"<?php if(date('m') == "10") echo(' selected="selected"'); ?>><?php _e("October"); ?></option>
				  <option value="11"<?php if(date('m') == "11") echo(' selected="selected"'); ?>><?php _e("November"); ?></option>
				  <option value="12"<?php if(date('m') == "12") echo(' selected="selected"'); ?>><?php _e("December"); ?></option>
				</select>
				 <select name="dd" id="dd">
				...
				<tr id="expire"<?php if($multi != 1) echo(' class="inactive"'); ?>>
					<th scope="row"><label for="mm"><strong><?php _e("End date", "gigpress") ?>:</strong></label></th>
			...
			<tr>
				<th scope="row"><label for="show_locale"><strong><?php _e("City", "gigpress") ?>:</strong></label></th>
			  ...
			  <tr>
				<th scope="row"><label for="show_venue"><strong><?php _e("Venue", "gigpress") ?>:</strong></label></th>
...
function gigpress_tours() {
	...
	<?php if(isset($_GET['gpaction']) && $_GET['gpaction'] == "edit") {
		...
		<table class="optiontable editform gp-table">
			<tr>
				<th scope="row"><label for="tour_name"><?php _e("Edit your tour name", "gigpress") ?>:</label></th>
		...
		<table class="optiontable editform gp-table">
			<tr>
				<th scope="row"><label for="tour_name"><?php _e("Add a new tour", "gigpress") ?>:</label></th>
...
function gigpress_options() {
	...
	<table class="optiontable editform gp-table niceblue">
		<tr>
	...
	<fieldset class="options" id="gpformatting">
		...
		<tr>
			<th scope="row"><?php _e("Default Country", "gigpress") ?>:</th>
			<td>
		...
		<tr>
			<th scope="row"><abbr title="<?php _e("Cascading Style Sheets", "gigpress"); ?>"><?php _e("CSS", "gigpress") ?></abbr></th>
			<td>
				<p><label>
...
function gigpress_sidebar_content($shows, $type) {
	...
	foreach ($shows as $show) {
		...
		echo("</span><br /><span class=\"summary\"><span class=\"hide\">". gigpress_sanitize(get_option('gigpress_band')) ." ".__("in", "gigpress")." </span>".gigpress_sanitize($show->show_locale)."</span> ".__("at", "gigpress")." <span class=\"location\">$venue</span></li>\n\t\t");
		$item++;
	} // end foreach show
}
...
function gigpress_admin_head() {
	...
	// If we're running WP < 2.2, we need to include our own jQuery
	if($GLOBALS['wp_version'] < "2.2" && strpos($_SERVER['QUERY_STRING'], 'gigpress') !== false) {
		echo('
		<script type="text/javascript" src="'. get_bloginfo('wpurl') .'/wp-content/plugins/gigpress/scripts/jquery-1.2.2.min.js"></script>
		');
	}
